...
const Welcome = () => {
  ...
  return (
    <section className={`w-full min-h-screen py-24 md:pt-32 lg:pt-32 px-12 lg:px-36 text-center ${darkMode ? "dark" : ""}`}>
        {/* <div className="w-[200px] sm:w-[300px] md:w-[400px] mx-auto absolute left-0 md:left-[15%] top-[30%] sm:top-[20%] md:flex z-[-1]">
        <img src={NotePNG} />
        </div> */}
        <article className="max-w-lg mx-auto mb-4 md:mb-7 font-article">
        <h3 className=" font-bold text-4xl md:text-4xl lg:text-5xl mb-4 md:mb-7">The simplest way to keep notes</h3>
